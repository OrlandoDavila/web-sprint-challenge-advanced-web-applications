...
1. Explain what a token is used for.
          It adds a layer of security that is typacially used in conjunction with a persons username and password.

2. What steps can you take in your web apps to keep your data secure?
          Input validation, encrypt data, implement HTTPS

3. Describe how web servers work.
          Web servers hold data that is passed on to a client. eg. HTTP Request => HTTP Response 
